...
// GetFollowersIDs ...
func (n Network) GetFollowersIDs(ctx context.Context, id string, isCompany bool) ([]string, error) {
	passContext(&ctx)

	resp, err := n.networkClient.GetFollowersIDs(ctx, &networkRPC.GetFollowersIDsRequest{
		ID:        id,
		IsCompany: isCompany,
	})
	if err != nil {
