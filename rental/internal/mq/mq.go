...
// OrderService ...
func (r *RabbitmqConnection) OrderService(userID string, message *notmes.NewOrder) error {
	message.Type = notmes.TypeNewOrder
...
func (r *RabbitmqConnection) SendProposalForServiceRequest(companyID string, message *notmes.NewProposal) error {
	message.Type = notmes.TypeNewProposal
	message.GenerateID()
