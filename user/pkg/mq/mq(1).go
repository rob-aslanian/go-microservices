...
// SendNewEndorsement ...
func (r *RabbitmqConnection) SendNewEndorsement(userID string, message *notmes.NewEndorsement) error {
	message.Type = notmes.TypeNewEndorsement
...
// SendEmail ...
func (r *RabbitmqConnection) SendEmail(emailAddress string, subject string, bodyMessage string) error {
